...
export default function SetupPage() {
  ...
  return (
    <main className="flex min-h-dvh flex-col">
      {/* Background overlay */}
      <div className="from-ice-500/10 absolute inset-0 bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] via-transparent to-transparent" />
      ...
      <div className="relative z-10 flex flex-1 flex-col px-4 py-6">
        ...
        {/* Title */}
        <h1 className="text-parchment-100 mb-6 text-center text-2xl font-bold tracking-wide uppercase">
          Player Setup
        </h1>
        ...
        <div className="mx-auto w-full max-w-md flex-1 space-y-3">
          {players.map((player, index) => (
            <div key={player.id} className="flex items-center gap-2">
              <span className="text-ice-400 w-8 text-center text-sm font-bold">
                {index + 1}.
              </span>
              <Input
                type="text"
